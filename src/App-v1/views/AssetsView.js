          ...
          <div className="space-y-3">
            ...
            <div className="bg-slate-700/50 rounded-lg p-3">
              ...
              <div className="h-32 flex items-end gap-1 mb-2">
                {[0, 0.2, 0.8, 2.1, 3.5, 4.2, 4.8, 5.1, 4.5, 3.2, 2.1, 1.5, 1.2, 0.9, 0.6, 0.3, 0.1, 0, 0, 0, 0, 0, 0, 0].map((value, idx) => {
                  const hour = idx;
                  const maxValue = 5.5;
    ...
    <div className="pb-24">
      ...
      <div className="px-4 pb-6">
        ...
        <div className="bg-slate-800 rounded-lg p-4 mb-3">
          ...
          >
            <div className="mb-3">
              <p className="text-sm font-semibold text-white mb-1">Octopus Go by Octopus Energy</p>
            </div>
