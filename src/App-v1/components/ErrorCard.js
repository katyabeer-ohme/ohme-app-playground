        ...
        <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 rounded-lg p-4 mx-4 mb-4 shadow-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-text-primary mb-1">Car Suspended</h3>
              <p className="text-xs text-text-secondary mb-3">
                Your vehicle has been temporarily suspended due to unusual charging patterns. Resolve this issue to continue using smart charging.
              </p>
              <button
                onClick={onResolve}
